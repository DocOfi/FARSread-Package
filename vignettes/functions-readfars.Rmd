...
You are now ready to use the `fars_read` function to explore the data. You might find the first vignette included in this package, "Introduction to FARSread" helpful for this purpose. Let's load the package `readFARS` to access the `fars_summarize_years`  and `fars_map_state` functions .
